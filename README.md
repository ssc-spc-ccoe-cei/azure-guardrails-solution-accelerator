...
The current release (v2.3.3beta2) available is undergoing final operations testing. It has passed all unit tests and ad hoc use case testing but still requires a final review.
...
La version actuelle (v2.3.3beta2) disponible fait l'objet de tests opérationnels finaux. Elle a passé avec succès tous les tests unitaires et les tests d'intégration, mais doit encore faire l'objet d'un dernier cycle d'assurance qualité.
