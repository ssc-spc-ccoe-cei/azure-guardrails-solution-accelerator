...
elseif ($resourceGroupState.State -ne 'Exists') {
    throw "Could not confirm whether resource group '$ResourceGroupName' exists before deletion. ARM status '$($resourceGroupState.StatusCode)': $($resourceGroupState.Message)"
}
