  ...
  properties: {
    dataFlows: [
      ...
      }
      {
        ...
        destinations: ['guardrails-law']
        transformKql: 'source | extend id_g = toguid(id), userPrincipalName_s = tostring(userPrincipalName), displayName_s = tostring(displayName), mail_s = tostring(mail), createdDateTime_t = todatetime(createdDateTime), userType_s = tostring(userType), homeTenantId_g = toguid(homeTenantId), homeTenantResolved_b = tobool(homeTenantResolved), accountEnabled_b = tobool(accountEnabled), guardrailsExcludedMfa_b = tobool(guardrailsExcludedMfa), guardrailsExcludedAgentUser_b = tobool(guardrailsExcludedAgentUser), isMfaRegistered_b = tobool(isMfaRegistered), isMfaCapable_b = tobool(isMfaCapable), isSsprEnabled_b = tobool(isSsprEnabled), isSsprRegistered_b = tobool(isSsprRegistered), isSsprCapable_b = tobool(isSsprCapable), isPasswordlessCapable_b = tobool(isPasswordlessCapable), defaultMethod_s = tostring(defaultMethod), isSystemPreferredAuthenticationMethodEnabled_b = tobool(isSystemPreferredAuthenticationMethodEnabled), userPreferredMethodForSecondaryAuthentication_s = tostring(userPreferredMethodForSecondaryAuthentication), methodsRegistered_s = tostring(methodsRegistered), systemPreferredAuthenticationMethods_s = tostring(systemPreferredAuthenticationMethods), ReportTime_s = tostring(ReportTime), signInActivity_lastSignInDateTime_t = todatetime(signInActivity.lastSignInDateTime), signInActivity_lastSignInRequestId_g = toguid(signInActivity.lastSignInRequestId), signInActivity_lastNonInteractiveSignInDateTime_t = todatetime(signInActivity.lastNonInteractiveSignInDateTime), signInActivity_lastNonInteractiveSignInRequestId_g = toguid(signInActivity.lastNonInteractiveSignInRequestId), signInActivity_lastSuccessfulSignInDateTime_t = todatetime(signInActivity.lastSuccessfulSignInDateTime), signInActivity_lastSuccessfulSignInRequestId_g = toguid(signInActivity.lastSuccessfulSignInRequestId), customSecurityAttributes_GCCloudGuardrails_ExcludeFromMFA_b = tobool(customSecurityAttributes.GCCloudGuardrails.ExcludeFromMFA), customSecurityAttributes_Guardrails_Excludedmfa_b = tobool(customSecurityAttributes.Guardrails.Excludedmfa) | project TimeGenerated, id_g, userPrincipalName_s, displayName_s, mail_s, createdDateTime_t, userType_s, homeTenantId_g, homeTenantResolved_b, accountEnabled_b, guardrailsExcludedMfa_b, guardrailsExcludedAgentUser_b, isMfaRegistered_b, isMfaCapable_b, isSsprEnabled_b, isSsprRegistered_b, isSsprCapable_b, isPasswordlessCapable_b, defaultMethod_s, isSystemPreferredAuthenticationMethodEnabled_b, userPreferredMethodForSecondaryAuthentication_s, methodsRegistered_s, systemPreferredAuthenticationMethods_s, ReportTime_s, signInActivity_lastSignInDateTime_t, signInActivity_lastSignInRequestId_g, signInActivity_lastNonInteractiveSignInDateTime_t, signInActivity_lastNonInteractiveSignInRequestId_g, signInActivity_lastSuccessfulSignInDateTime_t, signInActivity_lastSuccessfulSignInRequestId_g, customSecurityAttributes_GCCloudGuardrails_ExcludeFromMFA_b, customSecurityAttributes_Guardrails_Excludedmfa_b'
    ...
    streamDeclarations: {
      ...
      'Custom-GuardrailsUserRaw': {
        columns: [
          ...
          {
            name: 'guardrailsExcludedAgentUser'
            type: 'boolean'
          }
          {
