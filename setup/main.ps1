...
$guardrailId = 'GR1'
$runState = New-GuardrailRunState -GuardrailId $guardrailId -RunbookName 'main' -WorkSpaceID $WorkSpaceID -WorkspaceKey $WorkspaceKey -SubscriptionId $SubID -TenantId $tenantID -JobId $automationJobId -ReportTime $ReportTime
