...
noSslListenersFound = "No SSL listeners found for Application Gateway: {0}"
expiredCertificateFound = "Expired certificate found for listener '{0}' in Application Gateway '{1}'"
unapprovedCAFound = "Unapproved CA found for listener '{0}' in Application Gateway '{1}'. Issuer: {2}"
...
noHttpsBackendSettingsFound = "No HTTPS backend settings found for Application Gateway: {0}"
manualTrustedRootCertsFound = "Manual trusted root certificates found for Application Gateway '{0}', backend setting '{1}'"
allBackendSettingsUseWellKnownCA = "All backend settings for Application Gateway '{0}' use well-known CA certificates"
noAppGatewayFound = "No Application Gateways found in any subscription"
allCertificatesValid = "All certificates are valid and from approved CAs"
