...
lockLevelApproved = The Log Analytics Workspace {0} has approved lock level(s): {1}. 
lockLevelNotApproved = The Log Analytics Workspace {0} has unapproved lock level(s): {1}. Approved lock levels are 'ReadOnly' or 'DeleteOnly'.
