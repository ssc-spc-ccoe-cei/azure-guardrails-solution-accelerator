...
lockLevelApproved = L'espace de travail d'analyse de journaux {0} a des niveaux de verrouillage approuvés: {1}.
lockLevelNotApproved = L'espace de travail d'analyse de journaux {0} a des niveaux de verrouillage non approuvés: {1}. Les niveaux de verrouillage approuvés sont ' ReadOnly ' ou ''DeleteOnly '.
