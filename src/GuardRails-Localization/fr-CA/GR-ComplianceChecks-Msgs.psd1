...
FoundationalCspmOnlyInfo = [Information] Seul le plan CSPM fondamental (niveau gratuite) est actuellement activé pour cet abonnement. Les plans Defender CSPM et CWP ne sont activés.
