...
adminAccessConditionalPolicy = Politique d'accès conditionnel pour l'accès administrateur.
...
noDeviceFilterPolicies = Aucune politique conforme n’a été trouvée. Au moins une stratégie doit avoir des filtres d’appareil activés avec des ressources cibles, des rôles d’administrateur inclus et activés.
noLocationFilterPolicies = Aucune politique conforme n’a été trouvée. Au moins une politique doit vérifier les emplacements nommés/approuvés avec des rôles d’administrateur inclus et activés.
hasDeviceFilterPolicies = Détection d’au moins une stratégie conforme pour le filtre d’appareil et la ressource cible - effectué.
hasLocationFilterPolicies = Identifiez au moins une stratégie conforme pour les emplacements nommés/approuvés.
