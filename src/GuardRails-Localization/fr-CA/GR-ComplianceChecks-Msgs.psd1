...
lockLevelApproved = L'espace de travail d'analyse de journaux {0} a un ou plusieurs niveaux de verrouillage approuvés : {1}.
lockLevelNotApproved = L'espace de travail d'analyse de journaux {0} a un ou plusieurs niveaux de verrouillage non approuvés : {1}. Les niveaux de verrouillage approuvés sont « ReadOnly » ou « DeleteOnly ».
