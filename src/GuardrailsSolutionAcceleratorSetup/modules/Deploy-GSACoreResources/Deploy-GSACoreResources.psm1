Function Deploy-GSACoreResources {
    ...
    try {
        ...
        $appRoleIds = @("Organization.Read.All", "User.Read.All", "UserAuthenticationMethod.Read.All", "Policy.Read.All","Directory.Read.All","AuditLog.Read.All","AccessReview.Read.All","CustomSecAttributeAssignment.Read.All")
